...
start "TTS Dubbing Backend" cmd /c "cd /d %CD% && .venv\Scripts\python run.py --reload"

REM Start frontend in new window (if Node.js available)
if exist "frontend\node_modules" (
    start "TTS Dubbing Frontend" cmd /c "cd /d %CD%\frontend && npm run dev"
)
