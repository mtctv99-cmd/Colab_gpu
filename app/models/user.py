...
class ApiKey(Base):
    ...
    rate_limit = Column(Integer, nullable=True, default=None)  # max requests/hour
    allowed_ips = Column(String, nullable=True, default=None)  # JSON array of IPs
...
class UsageRecord(Base):
    ...
    type = Column(String, nullable=False, default="tts")
    created_at = Column(DateTime, default=lambda: datetime.now(timezone.utc))
