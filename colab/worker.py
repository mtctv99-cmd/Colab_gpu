...
OMNIVOICE_NUM_STEP = int(os.getenv("OMNIVOICE_NUM_STEP", "50"))
OMNIVOICE_GUIDANCE_SCALE = float(os.getenv("OMNIVOICE_GUIDANCE_SCALE", "6.0"))
_REF_MAX_RAW = float(os.getenv("REF_AUDIO_MAX_SECONDS", "15"))
...
def main() -> None:
    ...
    if not worker_session_id:
        print("[warn] WORKER_SESSION_ID trống. Server sẽ reject kết nối. Kiểm tra form Colab đã fill đúng chưa.", flush=True)
